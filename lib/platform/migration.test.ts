...
describe("migration locale v0.7 vers v0.8",()=>{beforeEach(()=>{vi.stubGlobal("localStorage",new MemoryStorage());vi.stubGlobal("crypto",{randomUUID:()=>"journal-id"});localStorage.setItem(STORAGE_KEYS.classes,JSON.stringify([{id:"classe-a",name:"5e Année A",level:"5e Année",room:"1",academicYear:"2026-2027",mainSubject:"",updatedAt:"2026-01-01",students:[{id:"eleve-a",firstName:"Abel",lastName:"Ondo",email:"",registrationNumber:"M001",dateOfBirth:"2013-01-02",updatedAt:"2026-01-01"}]}]));});
