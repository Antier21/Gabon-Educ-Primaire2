...
const rolePermissions: Record<SchoolRole, Partial<Record<PermissionResource, PermissionAction[]>>> = {
  ...
  academic_director:{school:["view"],students:["view"],guardians:["view"],subjects:["view","create","update"],timetable:["view","create","update","delete"],attendance:["view"],announcements:["view","create","update"],reports:["view","update","validate"],documents:["view","create"]},
