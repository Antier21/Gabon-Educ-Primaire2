        ...
        <main className="auth-page">
          <section className="auth-aside">
            ...
            <div>
              ...
              <p>
                Profil choisi : <strong>{profileLabel}</strong>. Votre autorisation GEPS a déjà été vérifiée ; après cette étape, vous enregistrerez officiellement les informations de l’établissement.
              </p>
            </div>
            <small>Activation GEPS · Compte responsable · Enregistrement établissement</small>
          </section>
