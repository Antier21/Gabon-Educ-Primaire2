...
export default function SubscriptionPage(){
 ...
 return <main className="subscription-page"><header><Link href="/gabon-educ/administration"><ArrowLeft/>Administration</Link><div><ShieldCheck/><h1>Abonnement et licence</h1></div></header>
